...
* 2nd step: Matching rules
  ...
  * Skills section matching rules
  ...
  <p>Visit <a href="[https://github.blog/2013-01-31-relative-links-in-markup-files/](https://github.com/amiradridi/Job-Resume-Matching/blob/master/services/Semantic%20similarity.ipynb)">this notebook</a> for the full code of the semantic similarity approach.</p>
