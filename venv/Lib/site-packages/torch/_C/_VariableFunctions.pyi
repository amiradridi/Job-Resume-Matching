...
def _det_lu_based_helper(input: Tensor) -> torch.return_types._det_lu_based_helper: ...
...
def _foreach_abs(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_abs_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_acos(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_acos_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
@overload
def _foreach_add(tensors: Union[Tuple[Tensor, ...], List[Tensor]], scalar: Number) -> List[Tensor]: ...
@overload
def _foreach_add(tensors: Union[Tuple[Tensor, ...], List[Tensor]], scalars: Sequence[Number]) -> List[Tensor]: ...
@overload
def _foreach_add(tensors1: Union[Tuple[Tensor, ...], List[Tensor]], tensors2: Union[Tuple[Tensor, ...], List[Tensor]], *, alpha: Number=1) -> List[Tensor]: ...
@overload
...
@overload
def _foreach_addcdiv(input: Union[Tuple[Tensor, ...], List[Tensor]], tensor1: Union[Tuple[Tensor, ...], List[Tensor]], tensor2: Union[Tuple[Tensor, ...], List[Tensor]], value: Number=1) -> List[Tensor]: ...
@overload
def _foreach_addcdiv(input: Union[Tuple[Tensor, ...], List[Tensor]], tensor1: Union[Tuple[Tensor, ...], List[Tensor]], tensor2: Union[Tuple[Tensor, ...], List[Tensor]], scalars: Sequence[Number]) -> List[Tensor]: ...
@overload
...
@overload
def _foreach_addcmul(input: Union[Tuple[Tensor, ...], List[Tensor]], tensor1: Union[Tuple[Tensor, ...], List[Tensor]], tensor2: Union[Tuple[Tensor, ...], List[Tensor]], value: Number=1) -> List[Tensor]: ...
@overload
def _foreach_addcmul(input: Union[Tuple[Tensor, ...], List[Tensor]], tensor1: Union[Tuple[Tensor, ...], List[Tensor]], tensor2: Union[Tuple[Tensor, ...], List[Tensor]], scalars: Sequence[Number]) -> List[Tensor]: ...
@overload
...
def _foreach_asin(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_asin_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_atan(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_atan_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_ceil(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_ceil_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_cos(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_cos_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_cosh(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_cosh_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
@overload
def _foreach_div(tensors: Union[Tuple[Tensor, ...], List[Tensor]], scalar: Number) -> List[Tensor]: ...
@overload
def _foreach_div(tensors: Union[Tuple[Tensor, ...], List[Tensor]], scalars: Sequence[Number]) -> List[Tensor]: ...
@overload
def _foreach_div(tensors1: Union[Tuple[Tensor, ...], List[Tensor]], tensors2: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
@overload
...
def _foreach_erf(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_erf_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_erfc(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_erfc_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_exp(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_exp_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_expm1(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_expm1_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_floor(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_floor_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_frac(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_frac_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_lgamma(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_lgamma_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_log(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_log10(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_log10_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_log1p(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_log1p_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_log2(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_log2_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_log_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_maximum(tensors1: Union[Tuple[Tensor, ...], List[Tensor]], tensors2: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_minimum(tensors1: Union[Tuple[Tensor, ...], List[Tensor]], tensors2: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
@overload
def _foreach_mul(tensors: Union[Tuple[Tensor, ...], List[Tensor]], scalar: Number) -> List[Tensor]: ...
@overload
def _foreach_mul(tensors: Union[Tuple[Tensor, ...], List[Tensor]], scalars: Sequence[Number]) -> List[Tensor]: ...
@overload
def _foreach_mul(tensors1: Union[Tuple[Tensor, ...], List[Tensor]], tensors2: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
@overload
...
def _foreach_neg(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_neg_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_norm(tensors: Union[Tuple[Tensor, ...], List[Tensor]], ord: Number=2) -> List[Tensor]: ...
def _foreach_reciprocal(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_reciprocal_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_round(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_round_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_sigmoid(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_sigmoid_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_sin(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_sin_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_sinh(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_sinh_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_sqrt(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_sqrt_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
@overload
def _foreach_sub(tensors: Union[Tuple[Tensor, ...], List[Tensor]], scalar: Number) -> List[Tensor]: ...
@overload
def _foreach_sub(tensors: Union[Tuple[Tensor, ...], List[Tensor]], scalars: Sequence[Number]) -> List[Tensor]: ...
@overload
def _foreach_sub(tensors1: Union[Tuple[Tensor, ...], List[Tensor]], tensors2: Union[Tuple[Tensor, ...], List[Tensor]], *, alpha: Number=1) -> List[Tensor]: ...
@overload
...
def _foreach_tan(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_tan_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_tanh(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
def _foreach_tanh_(self: Union[Tuple[Tensor, ...], List[Tensor]]) -> None: ...
def _foreach_trunc(tensors: Union[Tuple[Tensor, ...], List[Tensor]]) -> List[Tensor]: ...
...
def _linalg_svd(A: Tensor, full_matrices: _bool=False, compute_uv: _bool=True, *, out: Union[Tensor, Tuple[Tensor, ...], List[Tensor]]=None) -> torch.return_types._linalg_svd: ...
...
def _masked_softmax(input: Tensor, mask: Tensor, dim: Optional[_int]=None) -> Tensor: ...
...
def _mps_linear_backward_weights(grad_output: Tensor, input: Tensor, weight: Tensor, bias_defined: _bool) -> Tuple[Tensor, Tensor]: ...
...
def _native_multi_head_attention(query: Tensor, key: Tensor, value: Tensor, embed_dim: _int, num_head: _int, qkv_weight: Tensor, qkv_bias: Tensor, proj_weight: Tensor, proj_bias: Tensor, mask: Optional[Tensor]=None, need_weights: _bool=True, average_attn_weights: _bool=True) -> Tuple[Tensor, Tensor]: ...
...
def _nested_tensor_from_mask(t: Tensor, mask: Tensor) -> Tensor: ...
...
def _reshape_alias_copy(input: Tensor, size: _size, stride: _size, *, out: Optional[Tensor]=None) -> Tensor: ...
...
def _transformer_encoder_layer_fwd(src: Tensor, embed_dim: _int, num_heads: _int, qkv_weight: Tensor, qkv_bias: Tensor, proj_weight: Tensor, proj_bias: Tensor, use_gelu: _bool, norm_first: _bool, eps: _float, norm_weight_1: Tensor, norm_bias_1: Tensor, norm_weight_2: Tensor, norm_bias_2: Tensor, ffn_weight_1: Tensor, ffn_bias_1: Tensor, ffn_weight_2: Tensor, ffn_bias_2: Tensor, mask: Optional[Tensor]=None) -> Tensor: ...
...
def as_strided_copy(input: Tensor, size: _size, stride: _size, storage_offset: Optional[_int]=None, *, out: Optional[Tensor]=None) -> Tensor: ...
...
def eig(input: Tensor, eigenvectors: _bool=False, *, out: Union[Tensor, Tuple[Tensor, ...], List[Tensor]]=None) -> torch.return_types.eig: ...
...
@overload
def expand_copy(input: Tensor, size: Sequence[SymInt], *, implicit: _bool=False, out: Optional[Tensor]=None) -> Tensor: ...
@overload
def expand_copy(input: Tensor, size: _size, *, implicit: _bool=False, out: Optional[Tensor]=None) -> Tensor: ...
...
def lstsq(input: Tensor, A: Tensor, *, out: Union[Tensor, Tuple[Tensor, ...], List[Tensor]]=None) -> torch.return_types.lstsq: ...
@overload
...
@overload
def narrow_copy(input: Tensor, dim: _int, start: _int, length: SymInt) -> Tensor: ...
@overload
...
def nested_tensor(list: Union[Tuple[Tensor, ...], List[Tensor]], dtype: Optional[_dtype]=None, layout: Optional[_layout]=None, device: Optional[Union[_device, str, None]]=None, pin_memory: Optional[_bool]=None) -> Tensor: ...
...
def select_copy(input: Tensor, dim: _int, index: _int, *, out: Optional[Tensor]=None) -> Tensor: ...
...
def slice_copy(input: Tensor, dim: _int=0, start: Optional[_int]=None, end: Optional[_int]=None, step: _int=1, *, out: Optional[Tensor]=None) -> Tensor: ...
def slice_scatter(input: Tensor, src: Tensor, dim: _int=0, start: Optional[_int]=None, end: Optional[_int]=None, step: _int=1) -> Tensor: ...
def slogdet(input: Tensor) -> torch.return_types.slogdet: ...
...
def split_copy(input: Tensor, split_size: _int, dim: _int=0, *, out: Union[Tuple[Tensor, ...], List[Tensor]]=None) -> None: ...
def split_with_sizes(input: Tensor, split_sizes: _size, dim: _int=0) -> List[Tensor]: ...
def split_with_sizes_copy(input: Tensor, split_sizes: _size, dim: _int=0, *, out: Union[Tuple[Tensor, ...], List[Tensor]]=None) -> None: ...
...
@overload
def tensor_split(input: Tensor, sections: _int, dim: _int=0) -> List[Tensor]: ...
@overload
def tensor_split(input: Tensor, indices: _size, dim: _int=0) -> List[Tensor]: ...
...
def unsafe_split(input: Tensor, split_size: _int, dim: _int=0) -> List[Tensor]: ...
def unsafe_split_with_sizes(input: Tensor, split_sizes: _size, dim: _int=0) -> List[Tensor]: ...
...
@overload
def view_copy(input: Tensor, size: _size, *, out: Optional[Tensor]=None) -> Tensor: ...
@overload
...
__all__ = ['__and__', '__lshift__', '__or__', '__rshift__', '__xor__', '_adaptive_avg_pool2d',
 ...
 '_cast_Int', '_cast_Long', '_cast_Short', '_choose_qparams_per_tensor', '_coalesce',
 ...
 '_det_lu_based_helper', '_det_lu_based_helper_backward_helper', '_dim_arange', '_dirichlet_grad',
 ...
 '_fused_moving_avg_obs_fq_helper', '_fused_moving_avg_obs_fq_helper', '_fw_primal_copy',
 ...
 '_is_zerotensor', '_linalg_check_errors', '_linalg_inv_out_helper_', '_linalg_qr_helper',
 '_linalg_svd', '_linalg_svd', '_log_softmax', '_log_softmax_backward_data', '_logcumsumexp',
 '_lstm_mps', '_lu_with_info', '_lu_with_info', '_make_dual', '_make_dual_copy',
 ...
 '_mps_convolution', '_mps_convolution_transpose', '_mps_linear_backward_weights',
 '_mps_max_pool2d', '_native_multi_head_attention', '_neg_view', '_neg_view_copy',
 '_nested_from_padded', '_nested_from_padded_and_nested_example', '_nested_tensor_from_mask',
 '_nnpack_available', '_nnpack_spatial_convolution', '_pack_padded_sequence',
 '_pad_packed_sequence', '_pin_memory', '_remove_batch_dim', '_reshape_alias_copy',
 ...
 '_sparse_broadcast_to', '_sparse_broadcast_to_copy', '_sparse_bsc_tensor_unsafe',
 '_sparse_bsr_tensor_unsafe', '_sparse_compressed_tensor_unsafe', '_sparse_coo_tensor_unsafe',
 '_sparse_csc_tensor_unsafe', '_sparse_csr_prod', '_sparse_csr_sum', '_sparse_csr_tensor_unsafe',
 '_sparse_log_softmax_backward_data', '_sparse_mask_helper', '_sparse_softmax_backward_data',
 '_sparse_sparse_matmul', '_sparse_sum', '_stack', '_standard_gamma', '_standard_gamma_grad',
 '_test_serialization_subcmul', '_to_cpu', '_torch_cuda_cu_linker_symbol_op',
 '_transform_bias_rescale_qkv', '_transformer_encoder_layer_fwd', '_trilinear', '_unique',
 '_unique2', '_unpack_dual', '_unpack_dual', '_use_cudnn_ctc_loss', '_use_cudnn_rnn_flatten_weight',
 ...
 '_weight_norm', '_weight_norm_interface', 'abs', 'abs_', 'absolute', 'acos', 'acos_', 'acosh',
 'acosh_', 'adaptive_avg_pool1d', 'adaptive_max_pool1d', 'add', 'addbmm', 'addcdiv', 'addcmul',
 'addmm', 'addmv', 'addmv_', 'addr', 'adjoint', 'affine_grid_generator', 'alias_copy', 'all',
 'allclose', 'alpha_dropout', 'alpha_dropout_', 'amax', 'amin', 'aminmax', 'aminmax', 'angle',
 'any', 'arange', 'arccos', 'arccos_', 'arccosh', 'arccosh_', 'arcsin', 'arcsin_', 'arcsinh',
 'arcsinh_', 'arctan', 'arctan2', 'arctan_', 'arctanh', 'arctanh_', 'argmax', 'argmin', 'argsort',
 'argwhere', 'as_strided', 'as_strided_', 'as_strided_copy', 'as_tensor', 'asarray', 'asin',
 ...
 'complex', 'concat', 'conj', 'conj_physical', 'conj_physical_', 'constant_pad_nd', 'conv1d',
 'conv2d', 'conv3d', 'conv_tbc', 'conv_transpose1d', 'conv_transpose2d', 'conv_transpose3d',
 'convolution', 'copysign', 'corrcoef', 'cos', 'cos_', 'cosh', 'cosh_', 'cosine_embedding_loss',
 'cosine_similarity', 'count_nonzero', 'cov', 'cross', 'crow_indices_copy', 'ctc_loss',
 ...
 'dstack', 'eig', 'eig', 'embedding', 'embedding_bag', 'embedding_renorm_', 'empty', 'empty_like',
 ...
 'logit', 'logit_', 'logspace', 'logsumexp', 'lstm', 'lstm_cell', 'lstsq', 'lstsq', 'lt',
 'lu_solve', 'lu_unpack', 'lu_unpack', 'margin_ranking_loss', 'masked_fill', 'masked_scatter',
 'masked_select', 'matmul', 'matrix_exp', 'matrix_power', 'matrix_rank', 'max', 'max', 'max_pool1d',
 'max_pool1d_with_indices', 'max_pool2d', 'max_pool3d', 'maximum', 'mean', 'median', 'median',
 'min', 'min', 'minimum', 'miopen_batch_norm', 'miopen_convolution', 'miopen_convolution_transpose',
 'miopen_depthwise_convolution', 'miopen_rnn', 'mkldnn_adaptive_avg_pool2d', 'mkldnn_convolution',
 'mkldnn_linear_backward_weights', 'mkldnn_max_pool2d', 'mkldnn_max_pool3d', 'mm', 'mode', 'mode',
 'moveaxis', 'movedim', 'msort', 'mul', 'multinomial', 'multiply', 'mv', 'mvlgamma', 'nan_to_num',
 ...
 'negative_', 'nested_tensor', 'nextafter', 'nonzero', 'norm_except_dim', 'normal', 'not_equal',
 ...
 'swapdims', 'symeig', 'symeig', 't', 't_copy', 'take', 'take_along_dim', 'tan', 'tan_', 'tanh',
 'tanh_', 'tensor', 'tensor_split', 'threshold', 'threshold_', 'tile', 'topk', 'topk', 'trace',
 'transpose', 'transpose_copy', 'trapezoid', 'trapz', 'triangular_solve', 'triangular_solve',
 'tril', 'tril_indices', 'triplet_margin_loss', 'triu', 'triu_indices', 'true_divide', 'trunc',
 'trunc_', 'unbind', 'unbind_copy', 'unfold_copy', 'unique_dim', 'unsafe_chunk', 'unsafe_split',
