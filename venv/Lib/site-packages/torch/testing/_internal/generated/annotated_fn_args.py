...
annotated_args = {
    ...
    torch._C._VariableFunctions._mps_linear_backward_weights: [{'name': 'grad_output', 'simple_type': 'Tensor'}, {'name': 'input', 'simple_type': 'Tensor'}, {'name': 'weight', 'simple_type': 'Tensor'}, {'name': 'bias_defined', 'simple_type': 'bool'}],
    ...
    torch._C._nn.linear: [{'name': 'input', 'simple_type': 'Tensor'}, {'name': 'weight', 'simple_type': 'Tensor'}],
    torch._C._nn._mps_linear: [{'name': 'self', 'simple_type': 'Tensor'}, {'name': 'weight', 'simple_type': 'Tensor'}],
